...
namespace Hawk
{
	...
	void HawkUtil::Init()
	{
		...
		HawkSessionManager::InitInstance();
		...
		HawkSessionManager::GetInstance()->Start();
	...
	void HawkUtil::Tick(UInt32 iPeriod)
	{
		...
		HawkSessionManager::GetInstance()->Tick(iPeriod);
	...
	void HawkUtil::Stop()
	{
		...
		HawkSessionManager::GetInstance()->Stop();
	...
	void HawkUtil::Release()
	{
		...
		HawkSessionManager::ExitInstance();
