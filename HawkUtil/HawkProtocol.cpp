...
namespace Hawk
{
	HawkProtocol::HawkProtocol(ProtoType iType) : m_iType(iType), m_iSize(0), m_iCrc(0)
	{
	}
	...
	Bool HawkProtocol::Send(SID iSid, const SocketAddr* pAddr)
	{
		return P_SessionManager->SendProtocol(iSid, this, pAddr);
	}
}
